...
* **Student Registration Number:** 24/UG/654/BSCE-J
...
* `CML3112_24_UG_654_BSCE_J_W02.ipynb` - The primary verified execution notebook.
* `california_housing_train.csv` - The source dataset containing regional survey details.

## Run Instructions
1. Open the notebook file `CML3112_24_UG_654_BSCE_J_W02.ipynb` in Google Colab.
